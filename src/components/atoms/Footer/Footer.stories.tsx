...
import { FooterSocialAnchor } from '@/components/atoms/Footer/FooterSocialAnchor';
      ...
      links={[
        {
          ...
          links: (
            <>
              <FooterLink to="/">Test link</FooterLink>
              <FooterLink to="/">Test link 2</FooterLink>
              <FooterLink to="/">Test link 3</FooterLink>
            </>
          ),
        },
        {
          ...
          links: (
            <>
              <FooterLink to="/">Test link 4</FooterLink>
              <FooterLink to="/">Test link 5</FooterLink>
              <FooterLink to="/">Test link 6</FooterLink>
            </>
          ),
        },
      ]}
