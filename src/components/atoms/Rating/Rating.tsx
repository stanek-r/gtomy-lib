...
export function Rating({ label, hint, error, half, className, value, amount, size, ...other }: RatingProps) {
  return (
    <div className="flex flex-col gap-2">
      <Typography>{label}</Typography>
      <div className="flex items-center gap-4">
        <div className={twMerge('rating rating-', size && ratingSizeClasses[size], half && 'rating-half')}>
